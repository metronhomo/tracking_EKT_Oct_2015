...
base_open <- readRDS("data/base_open.rds")
...
p16 <- base_open[,c(3:29)]
p19 <- base_open[,c(3:13,30:45)]
...
target <- c("COMUNES A LA CATEGORÍA", "LÍNEA BLANCA", "TELEFONÍA", "PANTALLAS","ELECTRÓNICA","CÓMPUTO",
            ...
            "CORRECTO ESPECÍFICO", "FAMILIA EN LA TIENDA VIENDO PRODUCTOS","PERSONAL PROMOCIONANDO ARTÍCULOS DENTRO DE LA TIENDA ELEKTRA",
...
target2 <- c("COMUNES A LA CATEGORÍA",
             "TELEFONÍA",
             "LÍNEA BLANCA",
             "PANTALLAS",
             "CÓMPUTO",
             ...
             "CORRECTO ESPECÍFICO",
             "NIÑOS CON TABLETS PROMOCIONANDO EL REGRSO A CLASES CON COPPEL",
             "JÓVENES CANTANDO Y BAILANDO",
