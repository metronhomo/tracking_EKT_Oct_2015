                              ...
                              mainPanel(
                                tabsetPanel(
                                  ...
                                  tabPanel("Qué recuerda de la publicidad de EKT",
                                           br(),
                                           br(),
                                           column(12,plotOutput("nube_P16_1",height=100,width=1300))),
                                  tabPanel("Qué ideas le transmitió la publicidad de EKT",
                                           br(),
                                           br(),
                                           column(4,plotOutput("nube_P16A_1",height=100,width=1300))),
                                  ...
                                  tabPanel("Qué recuerda de la publicidad de Coppel",
                                           br(),
                                           br(),
                                           column(4,plotOutput("nube_P19_1",height=100,width=1300))),
                                  tabPanel("Qué ideas le transmitió la publicidad de Coppel",
                                           br(),
                                           br(),
                                           column(4,plotOutput("nube_P19A_1",height=100,width=1300))),
